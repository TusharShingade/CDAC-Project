...
export default function ViewVendorAdmin() {

    const [data, setData] = useState([]);

    useEffect(() => {

        fetch("https://localhost:7074/api/Logins/role2").then(res => res.json()).then(data => setData(data))
    }, []);
    ...
    return (
        ...
        <h2 className="text-center"><b>Vendor Details</b></h2>
